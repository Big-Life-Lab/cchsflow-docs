...
label define   COV2_041_FMT ///
     ...
     03  "Je n’ai pas confiance dans le vaccin qui m’a été offert" ///
     04  "Rendez-vous prochainement" ///
     05  "Pas encore réussi à obtenir de rendez-vous" ///
     06  "Sais pas à quel endroit se faire vacciner" ///
     07  "Malade au moment où offert la possibilité d'être vacciner" ///
     08  "Vaccin n’est pas recommandé pour moi" ///
     09  "Déjà eu la COVID-19" ///
     10  "Pas eu le temps" ///
     11  "Crois pas nécessaire, risques d'avoir COVID-19 sont faibles" ///
     12  "Autre raison" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
...
label define   COV2_55A_FMT ///
     01  "Une dose est suffisante pour protéger de la COVID-19" ///
     02  "Ne savait pas besoin d'une 2e dose" ///
     03  "Mauvaise réaction suite à la première dose" ///
     04  "Inquiétudes concernant effets secondaires associés à 2e dose" ///
     05  "Vaccin voulu pour 2e dose n’est pas disponible" ///
     06  "Rendez-vous prochainement" ///
     07  "Trop difficile obtenir un 2e rendez-vous" ///
     08  "Déjà eu la COVID-19" ///
     09  "Ne croit pas nécessaire, risques d'avoir COVID-19 faibles" ///
     10  "Autre raison" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
...
label define   HMC_037_FMT ///
     ...
     4  "Les soins à domicile n’étaient pas reliés au besoin de demeu" ///
     6  "Enchaînement valide" ///
     7  "Ne sait pas" ///
     8  "Refus" ///
     9  "Non déclaré"
...
label define   INJ_10_FMT ///
     01  "Faire du vélo" ///
     02  "Sport ou activité physique" ///
     03  "Tâches ménagères, travaux extérieurs ou travail non rémunéré" ///
     04  "Conducteur ou passager d’un véhicule motorisé" ///
     05  "Travailler à un emploi rémunéré ou à son propre compte" ///
     06  "Autre" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
...
label define   INJ_15A_FMT ///
     01  "En pratiquant des activités physiques" ///
     02  "En montant ou en descendant un escalier" ///
     03  "En glissant ou en trébuchant pendant une marche" ///
     04  "En montant ou en descendant d’un meuble" ///
     05  "D’une position élevée" ///
     06  "En raison d’un problème de santé" ///
     07  "Autre" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
...
label define   INJ_20A_FMT ///
     1  "Bureau du médecin ou clinique" ///
     2  "Salle d’urgence d’un hôpital" ///
     3  "Bureau d’un chiropraticien ou physiothérapeute" ///
     4  "Autre" ///
     6  "Enchaînement valide" ///
     7  "Ne sait pas" ///
     8  "Refus" ///
...
label define   INJ_35_FMT ///
     01  "Multiples parties du corps" ///
     02  "Tête ou cou" ///
     03  "Épaule ou haut du bras" ///
     04  "Coude ou avant-bras" ///
     05  "Poignet ou main" ///
     06  "Hanche ou cuisse" ///
     07  "Genou ou partie inférieure de la jambe" ///
     08  "Cheville ou pied" ///
     09  "Dos ou colonne vertébrale" ///
     10  "Poitrine" ///
     11  "Abdomen ou bassin" ///
     12  "Autre" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
...
label define   OHM3_10_FMT ///
     01  "Moins d’un an" ///
     02  "1 an à moins de 2 ans" ///
     03  "2 ans à moins de 3 ans" ///
     04  "3 ans à moins de 4 ans" ///
     05  "4 ans à moins de 5 ans" ///
     06  "5 ans ou plus" ///
     96  "Enchaînement valide" ///
     97  "Ne sait pas" ///
     98  "Refus" ///
